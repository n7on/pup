...
```
Set-PupCookie -Page <PupPage> -Name <String> -Value <String> [-Domain <String>] [-Path <String>]
...
```
Set-PupCookie -Page $page -Name "session" -Value "admin_session_token" -Domain "target.com"
```
...
```
Set-PupCookie -Page $page -Name "auth" -Value "token123" -Domain "target.com" -HttpOnly -Secure -SameSite Strict
```
...
Set-PupCookie -Page $page -Name "PHPSESSID" -Value "fixated_session_id" -Domain "target.com"
