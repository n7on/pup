...
```
Export-PupPdf -Page <PupPage> [-FilePath <String>] [-Landscape] [-NoPrintBackground] [-Format <String>]
...
```
Export-PupPdf -Page $page -FilePath "evidence.pdf"
```
...
```
$bytes = Export-PupPdf -Page $page -PassThru
...
```
Export-PupPdf -Page $page -FilePath "report.pdf" -Landscape -PrintBackground
```
