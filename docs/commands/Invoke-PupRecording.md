...
## DESCRIPTION
Replays an array of recorded events on the specified page.
Events are obtained from Get-PupRecording and can include clicks, typing, navigation, scrolling, and key presses.
Duplicate and redundant events are automatically filtered out during replay.
Use -Delay to add a fixed pause between each action.
