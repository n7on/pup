...
### ByFilter
```
Remove-PupCookie -Page <PupPage> [-Name <String>] [-Domain <String>] [-Path <String>] [-Url <String>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### ByObject
```
Remove-PupCookie -Page <PupPage> -Cookies <PupCookie[]> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```
Remove-PupCookie -Page $page -Name "session" -Domain "target.com"
```
...
Remove-PupCookie -Page $page -Name "auth_token" -Domain "target.com"
