...
```
Get-PupNetwork -Page <PupPage> [-IncludeContent] [-MaxContentBytes <Int32>] [-PassThru]
...
```
$requests = Get-PupNetwork -Page $page
...
```
$requests = Get-PupNetwork -Page $page -IncludeContent
